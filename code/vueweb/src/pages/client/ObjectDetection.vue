<template>
  <div id="ObjectDetection">
    <div id="Content">
      ...
      <div id="aLeftSide">
        ...
        >
          ...
          <div style="height: 400px;margin-left:40px;" class="stepDiv">
            ...
            >
              <el-step style="height: 75px;padding-bottom: 0px !important;" title="步骤 1">
                <template slot="description">
                  <!-- 上传文件 -->
                  上传待检测的图片
                  <el-button
          ...
          >
            <div class="imagePreview1">
              ...
              <div class="imgInfo" style="border-radius: 0 0 5px 5px">
                <span style="color: white; letter-spacing: 6px">待目标检测图片</span>
              </div>
            </div>
          ...
          <el-tabs v-model="activeName" @tab-click="handleClick">
            ...
            <el-tab-pane label="结果图像" name="second">
              ...
              >
                ...
                <el-table-column label="目标数量" class="elTbColum">
                  <template slot-scope="scope">
      ...
      <!--弹框-->
      <div>
        <el-dialog title="请选择检测目标" :visible.sync="dialogIsVisible" width="30%">
          <el-form ref="form" :model="form" label-width="80px">
            <el-form-item label="目标">
              <el-radio-group v-model="form.resource" style="vertical-align: center">
                <el-radio label="aircraft" class="radioLabel"></el-radio>
                <el-radio label="playground" class="radioLabel"></el-radio>
                <el-radio label="oiltank" class="radioLabel"></el-radio>
...
export default {
  ...
  methods: {
    ...
    updateImg(e) {
      ...
      // 发起上传请求
      axios.post("/objectDetection/uploadImg", param, config)
          .then((response) => {
    ...
    objectDetection() {
      ...
      console.log("开始目标检测");
      // 发起处理请求
      axios.post("/objectDetection/handle",
          {objectName: this.form.resource, imgName: getUrlName(this.imgUrl)}, {timeout: 1000 * 60 * 3})
          .then((response) => {
            console.log(response);
            console.log('处理完毕');
            this.imgResultUrl = response.data.srcListResult[0];
    ...
    downloadByName(name) {
      ...
      a.href = '/objectDetection/download/' + name
      a.download = name
      a.click()
    },
    downloadResultImg() {
    ...
    uploadZip(e) {
      ...
      // 发起上传请求
      axios.post("/objectDetection/uploadZip", param, config)
          .then((response) => {
            console.log(response);
      ...
      let intervalId = setInterval(() => {
        ...
        axios.post("/objectDetection/getProgressNum", {zipRandomId: this.zipRandomId})
            .then((response) => {
